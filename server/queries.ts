...
export class Queries {
    ...
    getCountryOfCity = (request: any, response: any) => {
        const place_id = parseInt(request.params.place_id)
        pool.query(`SELECT country.gid, country.country FROM world_countries country, world_cities city
        WHERE st_intersects(country.geom, city.geom) AND city.gid = $1;`,
